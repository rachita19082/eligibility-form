      ...
      faq: {
              copy: [
                        ...
                        },
                        {
                          ...
                          text: "A project as a whole, or its subcomponents must contribute to the attainment of the Sustainable Development Goals. For example, a project with a goal, mission or vision relevant to an SDG, or a project that produces a data set relevant to an SDG would qualify. In either case, there must be clear intentions to further the SDG in question through your work."
                        }
                    ],
              name: "SDG",
      ...
      faq: {
          copy: [
                  ...
                  },
                  {
                    ...
                    text: <p>For open source software, only <a href="https://opensource.org/licenses" style={{color:'black', textDecoration:'underline'}}>OSI approved licenses</a> are accepted. 
                             For open content, the use of a <a href="https://creativecommons.org/licenses/" style={{color:'black', textDecoration:'underline'}}>Creative Commons license</a> is required. 
                             For open data, an <a href="https://opendefinition.org/licenses/" style={{color:'black', textDecoration:'underline'}}>Open Data Commons</a> approved license is required. 
                             See the <a href="https://github.com/unicef/publicgoods-candidates/blob/master/docs/licenses.md" style={{color:'black', textDecoration:'underline'}}>full license list here</a> for reference.
                          </p>
                  },
                  {
                    ...
                    text: <p>While we encourage projects to use a license that allows for both derivatives and commercial 
                             reuse (CC-BY and CC-BY-SA) or dedicates content to the public domain (<a href="https://creativecommons.org/choose/zero/" style={{color:'black', textDecoration:'underline'}}>CC0</a>); 
                             licenses that do not allow for commercial reuse (<a href="https://creativecommons.org/licenses/by-nc/4.0/" style={{color:'black', textDecoration:'underline'}}>CC-BY-NC</a> and <a href="https://github.com/unicef/publicgoods-candidates/blob/master/docs/licenses.md" style={{color:'black', textDecoration:'underline'}}>CC-BY-NC-SA</a>) are also accepted.
                          </p>
                  }
                ],
        name: "open license",
      ...
      copy: [
              {
                ...
                text: <p>Supported standards may include HTML, CSS, HTTP, JSON, REST, WCAG et al. Best practices may include <a href="https://digitalprinciples.org/principles/" style={{color:'black', textDecoration:'underline'}}>Principles for Digital Development</a> 
                         or other industry/sector specific best practices. 
                      </p>
              }
            ],
